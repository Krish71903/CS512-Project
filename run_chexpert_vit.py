"""
Run Few-Shot Learning on CheXpert with Vision Transformer (ViT)
"""
import sys
import torch
import random
...
def main():
    """Run few-shot learning with Vision Transformer"""
    ...
    Config.BACKBONE = "vit_base"  # Vision Transformer Base
    ...
    Config.LEARNING_RATE = 1e-3  # Same as fast
    ...
    print("\n" + "="*80)
    print("FEW-SHOT LEARNING WITH VISION TRANSFORMER (ViT)")
    print("="*80)
    ...
    print(f"\nNote: ViT often outperforms CNNs in few-shot scenarios!")
    ...
    visualizer.plot_training_curves(
        ...
        trainer.train_accs,
        trainer.val_accs,
        save_name="training_curves_vit.png"
    )
    
    visualizer.plot_shot_comparison(shot_results, n_way=Config.N_WAY, 
                                    save_name="shot_comparison_vit.png")
    
    if way_results:
        visualizer.plot_way_comparison(way_results, k_shot=Config.K_SHOT,
                                       save_name="way_comparison_vit.png")
    
    visualizer.plot_accuracy_distribution(shot_results,
                                         save_name="accuracy_distribution_vit.png")
    
    visualizer.plot_comprehensive_results(shot_results, way_results)
    
    print("\n" + "-"*80)
    print("RESULTS SUMMARY (ViT)")
    print("-"*80)
    visualizer.create_results_summary(shot_results, "chexpert_vit_shot_results.csv")
    
    if way_results:
        visualizer.create_results_summary(way_results, "chexpert_vit_way_results.csv")
    
    # ========================================
    # FINAL SUMMARY
    # ========================================
    print("\n" + "="*80)
    print("[SUCCESS] ViT EXPERIMENT COMPLETE!")
    print("="*80)
    print(f"\nBest Validation Accuracy: {best_val_acc:.4f}")
    print(f"\nResults saved to: {Config.RESULTS_DIR}")
    print("\nGenerated files:")
    print("   - training_curves_vit.png")
    print("   - shot_comparison_vit.png")
    print("   - chexpert_vit_shot_results.csv")
    print("\n" + "="*80 + "\n")
